                                    ...
                                    <div className="header-navigation">
                                        ...
                                        <ul className="header-menu header-list">
                                            <li className="nav-list">
                                                <a href="index-2.html" className="list-item">
                                                ...
                                                <ul className="header-sub-menu">
                                                    ...
                                                    <li>
                                                        <a href="home-two.html" className="list-item">
                                                            <span className="list-text">Homepage-02</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="home-three.html" className="list-item">
                                            ...
                                            <li className="nav-list">
                                                <a href="about-us.html" className="list-item">
                                            ...
                                            <li className="nav-list">
                                                ...
                                                <ul className="header-sub-menu">
                                                    <li>
                                                        <a href="hotel-ameneties.html" className="list-item">
                                                    ...
                                                    <li>
                                                        <a href="hotel-list.html" className="list-item">
                                                            <span className="list-text">Hotel-List</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="agent-profile.html" className="list-item">
                                                            <span className="list-text">Agent-Profile</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="hotel-error.html" className="list-item">
                                            ...
                                            <li className="nav-list">
                                                ...
                                                <ul className="header-sub-menu">
                                                    <li>
                                                        <a href="blog-details.html" className="list-item">
                                                            <span className="list-text">Blog-Details</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-errors.html" className="list-item">
                                                            <span className="list-text">Blog-Error</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-grid.html" className="list-item">
                                                            <span className="list-text">Blog-Grid</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-sidebar.html" className="list-item">
                                            ...
                                            <li className="nav-list">
                                                ...
                                                <ul className="header-sub-menu">
                                                    <li>
                                                        <a href="pricing.html" className="list-item">
                                                            <span className="list-text">Pricing</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="payment-mathod.html" className="list-item">
                                                    ...
                                                    <li>
                                                        <a href="maintenance.html" className="list-item">
                    ...
                    <div className="container">
                        ...
                        <div className="category-section">
                            <a
                                ...
                                className="category-wrapper center-item"
                                data-aos="fade-right"
                                data-aos-delay={250}
                            >
